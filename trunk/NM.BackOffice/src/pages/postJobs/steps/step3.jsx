...
const Step3 = ({ setGoSteps, state, setState, onhandlechange, handleChange, values }) => {
    ...
    return <div className="m-auto w-100">
        ...
        <Form.Group>
            <Input type='text' className="form-control label-size mb-3" onChange={handleChange} placeholder='Industries' name='industry' value={values.industries} label={"Industries"} id="name" />
        </Form.Group>
