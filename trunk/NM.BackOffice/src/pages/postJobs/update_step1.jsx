        ...
        <Row>
            ...
            <div className="w-100">
                ...
                <Form.Group className="mb-3 w-100" controlId="formBasicEmail"  >
                    ...
                    <Form.Control type="text" value={state?.functions} name='functions' id="name" className="label-size"
                        onChange={(e) => handleFieldchange(e)} />
                </Form.Group>
                </div>
                <Form.Group className="mb-3" controlId="exampleForm.ControlTextarea1">
                <Form.Label>Description</Form.Label>
                <Form.Control as="textarea" rows={3} value={state?.description} name="description" className="label-size"
                    onChange={(e) => handleFieldchange(e)} />
            </Form.Group>
            </Col>
        </Row>
