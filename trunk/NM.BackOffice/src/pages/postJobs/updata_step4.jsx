...
const Update_Step4 = ({
  ...
  useEffect(() => {
    setState((old) => {
      const newState = {
        ...state,
        jobRequirments: state.jobRequirments
          ? JSON.stringify(state.jobRequirments)
          : [],
        jobBenefits: state.jobBenefits ? JSON.stringify(state.jobBenefits) : [],

        jobResponsibilityTypes: state.jobResponsibilityTypes
          ? JSON.stringify(state.jobResponsibilityTypes)
          : [],
      };
      return newState;
    });
