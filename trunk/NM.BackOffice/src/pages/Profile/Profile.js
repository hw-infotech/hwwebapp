...
import { GET_profile_data, Profile_Data, Update_Profile_Data } from "../../Services/redux/action/action";
                    ...
                    <div className="main-Profile-card">
                        <div className="Profile-card">
                           ...
                           <img src="" className="profile-image11" />
                            ...
                            <div className="card-heading4"><h3>Welcome, <strong>{data1?.name}</strong></h3>
