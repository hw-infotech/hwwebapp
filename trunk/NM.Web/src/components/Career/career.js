                    ...
                    <div className="row">
                        <div className="col-12 col-sm-12 col-md-8 col-lg-8">
                            <div className="careerContent">
                                <h1>Join us to showcase your expertise! </h1>
                                <p>If you are a budding technoartist and dream to do excel in your career, join Nestromind! We care, adore, and empower the talent that will be nurtured well in our extreme professional environment. Join us today!</p>
