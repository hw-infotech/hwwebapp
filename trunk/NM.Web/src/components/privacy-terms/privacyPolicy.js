...
<div className="mantras">
   <div className="container">
      <div className="mantra-top">
         <div className="mantra-title">Privacy Policy</div>
         ...
         <div className="mantra-title">Use Of Information</div>
         <div className="content-fund-section">
         ...
         <div className="mantra-title">Use of Cookies</div>
         <div className="content-fund-section">
         ...
         <div className="mantra-title">Compliance with Regulatory Authorities</div>
         <div className="content-fund-section">
         ...
         <div className="mantra-title">Right to Change the Policy</div>
         <div className="content-fund-section">
