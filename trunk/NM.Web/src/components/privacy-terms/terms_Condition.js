...
<>
<NavBar />
<div className="conditionsBanner">
...
<div className="mantras">
   <div className="container">
      <div className="mantra-top">
         <div className="mantra-title"> Terms of  Service</div>
         <div className="content-fund-section">
         ...
         <div className="mantra-title">Scope</div>
         <div className="content-fund-section">
         ...
         <div className="mantra-title">Communication</div>
         <div className="content-fund-section">
         ...
         <div className="mantra-title">Payment</div>
         <div className="content-fund-section">
         ...
         <div className="mantra-title"> Indemnification</div>
         <div className="content-fund-section">
         ...
         <div className="mantra-title">Service and Maintenance</div>
         <div className="content-fund-section">
         ...
         <div className="mantra-title">Termination</div>
         <div className="content-fund-section">
         ...
         <div className="mantra-title">Governing Law and Jurisdiction</div>
         <div className="content-fund-section">
         ...
         <div className="mantra-title">Disclaimer of Liability and Warranty</div>
         <div className="content-fund-section">
