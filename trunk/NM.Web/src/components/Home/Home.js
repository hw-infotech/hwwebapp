                        ...
                        <div className="item">
                            <div className="successStories skyblue">
                                <div className="row">
                                    ...
                                    <div className="col-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">
                                        <div className="storiesContent">
                                            <div className="title">FundersLink</div>
                                        ...
                                        <div className="card">
                                            ...
                                            <div id="collapseOne" className="collapse show" aria-labelledby="headingOne" data-parent="#accordion">
                                                <div className="card-body">
                                                    sdd We offer a full range of website and mobile app development services from scratch. From Responsive Websites to Fast & Easy-to-Use Mobile Applications, we design and develop quality and cost-effective applications.
                                    </div>
                                            </div>
                                        </div>
                                        <div className="card">
