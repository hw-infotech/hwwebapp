      ...
      <div>
        <div className="underConstruction">
          <div className="ConstructionContent">
            ...
            <img
              className="underCont"
              src="assets/img/website_under-construct.png"
              alt=""
            />
          </div>
        </div>
        ...
        <div class="clb-social">
          <ul class="clb-social-holder font-titles icons">
            ...
            <li>
              <a
                target="_blank"
                href="https://in.linkedin.com/company/nestormindinfotech"
                class="linkedin"
              >
                ...
                <div className="row">
                  <div className="col-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">
                    <div className="storiesContent">
                      ...
                      <div className="bigTitle">
                        We re-engineered, re-architected World’s #1 Mum’s app
                        scale to 2.0 Million users
                      </div>
                      <div className="actionBtn">
                        <a href="#" className="caseStudies">
                          caseStudies
                ...
                <div className="row">
                  <div className="col-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">
                    <div className="storiesContent">
                      ...
                      <div className="bigTitle">
                        We present our unique, flexible and powerful suite of
                        software to run your entire business on cloud.
                      </div>
                      <div className="actionBtn">
                        <a href="#" className="caseStudies">
                          caseStudies
                ...
                <div className="row">
                  <div className="col-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">
                    <div className="storiesContent">
                      ...
                      <div className="bigTitle">
                        Virtual Care. Chat with your health team.
                      </div>
                      <div className="actionBtn">
                        <Link to="../telemedician_case" className="caseStudies">
                          caseStudies
                        </Link>
                      </div>
                    </div>
                ...
                <div className="row">
                  <div className="col-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">
                    <div className="storiesContent">
                      ...
                      <div className="bigTitle">
                        Task Project Design has been updated in project
                        ECommerce by Admin
                      </div>
                      <div className="actionBtn">
                        <a href="#" className="caseStudies">
          ...
          <div className="container">
            <div className="dddl-inner">
              <div className="left-inner">
                <div className="teaamSprint">Team Sprint</div>
                <OwlCarousel
                  className="owl-theme"
                  loop
                  items={1}
              ...
              <div className="right-inner">
                <div className="workProcess">Work Process</div>
                <ul>
                  <li>
                    <div className="image">
          ...
          <div className="container">
            <div className="addressConetnt">
              ...
              <div className="companyAddress">
                ...
                <div className="coporateOffice__address">
                  <strong>Phone:</strong> (0172) 4087063 / 5187063
                </div>
                {/* <div className="coporateOffice__address">
