                        ...
                        <div className="container">
                           <div className="subBox">
                              <div className="labelIcon">
                                 <img src={newsletter} alt="image" className="lazyloaded" data-ll-status="loaded" />
                              </div>
                              ...
                              <div className="newsletterPlan">
                                 <div className="tnp tnp-subscription-minimal ">
                                    <Formik onSubmit={handleFormSubmit} initialValues={{ email: "" }} validationSchema={validationSchema} >
                                       {({ handleSubmit, values }) => (
                                          <form onSubmit={e => {
                                             e.preventDefault()
                                             handleSubmit()
                                          }}>
                                             <Field className="tnp-email" type="email" name="email" placeholder="Email" />
