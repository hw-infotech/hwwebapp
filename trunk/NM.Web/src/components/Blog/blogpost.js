             ...
             <div className="leftPanel">
               <div className="post">
                 ...
                 <div className="title">
                   <h1>
                     <a href="">
                       Difference Between: Digitalization, Digitization and
                 ...
                 <div className="post_content">
                   ...
                   <p>
                     {" "}
                     Digitalization, Digitization and Digital Transformation are
                     the trending terms nowadays. But are these words similar or
                     do they have any difference. What is the importance of
                     these terms and how they are used?...
                   </p>
                   ...
                   <p>
                     SEO (search engine optimization) is that the series of
                     tactics you employ to urge search engines to spot your site
                     as a helpful solution to their users’ problems.
                   </p>

                   <p>
                     These techniques are often anything from creating a
                     positive user experience to developing meaningful content.
                   </p>

                   <p>
                     Shopify SEO may be a little different than other website
                     SEO, though. After all, you’re not just optimizing content.
                     You’re optimizing product listings.
                   </p>

                   <p>
                     This can present some unique problems which will negatively
                   ...
                   <p>
                     You walk into a brick-and-mortar store and therefore the
                     very first thing you see is products strewn everywhere the
                     ground .
                   </p>

                   <p>
                     {" "}
                     There are not any signs to direct you to any single
                     department, and you can’t find an employee to invite help.
                     ?
                   </p>
                   ...
                   <p>
                     {" "}
                     When someone visits your online shop, they need to be ready
                     to find items easily. There should be order and sense to
                     the structure of your store. Create a positive user
                     experience on your site by organizing its contents into a
                     couple of simplified categories.
                   </p>

                   <p>
                     {" "}
                     Don’t take customers too faraway from the house page.
                     Nobody wants to urge lost during a labyrinth of links as
                     they struggle to seek out one product. Consider a Home Page
                     Category Product Page structure.
                   </p>

                   <p>
                     {" "}
                     These features give your site credibility, connect
                     customers to your store, and help build trust with your
                     prospects.
                   </p>
                 </div>
