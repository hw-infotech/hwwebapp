           ...
           <div className="whiteWrap">
             <div className="leftPanel">
               <div className="post">
                 ...
                 <div className="post_content">
                   <p>
                     ...
                     customized experiences increasing, businesses must...
                   </p>
               ...
               <div className="post">
                 ...
                 <div className="title">
                   <h1>
                     <a href="">How To Use Shopify SEO To Desire?</a>
                   </h1>
                 </div>
                 <div className="post_image">
                   <a href="#">
                 ...
                 <div className="post_content">
                   <p>
                     Improving your Shopify SEO The retail industry has seen an
                     enormous shift in recent years as more people address the
                     web for his or her shopping needs. Between convenience (who
                     doesn’t like shopping in their pajamas?) and necessity (a
                     global pandemic...
                   </p>
                   <Link className="link" to="/blog-post">
                     [continue...]
