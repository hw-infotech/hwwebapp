                ...
                <div className="col-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">
                  <div className="bannerContentText">
                    ...
                    <p>
                      ...
                      seamless solutions that can meet the futuristic approach
                      of business.
                    </p>
                  </div>
                </div>
              ...
              >
                <div className="item">
                  <div className="item_Services appDevelopment">
                    ...
                    />
                    <p>
                      We offer agile app development services and our approach
                      is to provide tailored enterprise-grade mobile
                      applications for both Andriod and iOS platforms.
                    </p>
                ...
                <div className="item">
                  <div className="item_Services uiUxDevelopment">
                    ...
                    <p>
                      ...
                      functional B2B applications. We are a UX design company
                      and we believe that everything that affects the end-user
                ...
                <div className="item">
                  <div className="item_Services graphicsDevelopment">
                    ...
                    <p>
                      ...
                      to boost the impact on their audience that to outshine
                      their competitors through the power of visual
                      communication.
                    </p>
                    <div className="actBtn">
              ...
              <div className="row">
                <div className="col-12 col-sm-12 col-md-6 col-lg-6">
                  <div className="whatWeDo">
                    ...
                    <p>
                      We mingle technical expertise with creativity to deliver
                      an outstanding result. Our services including Web
                      development, UI & UX design, Mobile App Development, and
                      Digital Marketing are completely dedicated to businesses.
                      We are the partner of your digital transformation.
                    </p>
              ...
              <ul>
                  ...
                  <div className="contentOfProcess">
                    ...
                    <div className="SubTileContent">
                      <p>
                        ...
                        designs that will serve your business purpose and can
                        also boost the website to attain a top rank in the
                        search engines. Our websites are compatible with all
                        devices. This is a critical part of the responsive
                        front-end development but can also be highly useful for
                        a wide range of different marketing along with design
                        purposes.
                      </p>
                    </div>
                  </div>
                ...
                <li>
                  <div className="contentOfProcess">
                    ...
                    <div className="SubTileContent">
                      <p>
                        Our skilled designers can deliver diverse logos,
                        banners, filters, posts for the social media to serve
                        the purpose of the clinet’s business promotion by
                        drawing attention and appreciation from the audience.
                      </p>
                    </div>
                  </div>
                </li>
                  ...
                  <div className="contentOfProcess">
                    ...
                    <div className="SubTileContent">
                      <p>
                        ...
                        functionality. We tend to offer cutting edge results
                        that not only add value but also suit with the latest
                        business requirements by solving challenges.
                      </p>
                    </div>
                  </div>
                </li>
                  ...
                  <div className="contentOfProcess">
                    ...
                    <div className="SubTileContent">
                      <p>
                        ...
                        according to the business requirement without any
                        glitch. These are secure can’t be penetrated by any
                        external force.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="contentOfProcess">
                    ...
                    <div className="SubTileContent">
                      <p>
                        ...
                        satisfied with its overall functionality, then it goes
                        to be delivered. Developers also couple with clients to
