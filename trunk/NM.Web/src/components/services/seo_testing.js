                ...
                <div className="row">
                    <div className="col-12 col-md-5">
                        <div className="form">
                            ...
                            <Formik initialValues={initialValues} validationSchema={validationSchema} onSubmit={handlFormSubmit}>
                                {({ handleSubmit, handleChange, errors, values, touched }) => (
                                    <form onSubmit={e => {
                                        ...
                                        <div className="input-form">
                                            ...
                                            <div className="input-filed">
                                                <Field name="email" type="email" className="formControl" id={touched && touched.email && errors && errors.email ? "invalid" : ""} />
                                        ...
                                        <div className="input-form">
                                            ...
                                            <div className="input-filed">
                                                <Field name="message" id={touched && touched.message && errors && errors.message ? "invalid" : ""} as="textarea" type="text" rows="3" className="formControl" />
