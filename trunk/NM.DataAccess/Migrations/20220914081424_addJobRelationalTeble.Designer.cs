...
namespace NM.DataAccess.Migrations
{
    ...
    [Migration("20220914081424_addJobRelationalTeble")]
    partial class addJobRelationalTeble
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("NM.DataAccess.AggregatesModel.JobBenefits", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("NM.DataAccess.AggregatesModel.JobResponsibilityTypes", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.ToTable("JobResponsibilityTypes");
                });
            ...
            modelBuilder.Entity("NM.DataAccess.AggregatesModel.JobBenefits", b =>
                {
                    b.HasOne("NM.DataAccess.AggregatesModel.BenefitTypes", "BenefitTypes")
            ...
            modelBuilder.Entity("NM.DataAccess.AggregatesModel.JobResponsibilityTypes", b =>
                {
                    b.HasOne("NM.DataAccess.AggregatesModel.Job", "Job")
                        .WithMany("jobResponsibilityTypes")
                        .HasForeignKey("JobId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("NM.DataAccess.AggregatesModel.ResponsibilityType", "ResponsibilityType")
                        .WithMany("JobResponsibilityTypes")
            ...
            modelBuilder.Entity("NM.DataAccess.AggregatesModel.Job", b =>
                {
                    ...
                    b.Navigation("jobResponsibilityTypes");
                });
